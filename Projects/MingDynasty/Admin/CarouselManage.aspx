<%@ Page Title="轮播图管理" Language="C#" MasterPageFile="~/Admin/Site_a.master" AutoEventWireup="true" CodeFile="CarouselManage.aspx.cs" Inherits="Admin_CarouselManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="ming-card animate__animated animate__zoomIn">
            <div class="card-header">
                <h5 class="card-title">
                    ...
                    <asp:Literal ID="litEditTitle" runat="server" Text="新增轮播图"></asp:Literal>
                </h5>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-3">
                            <label for="txtLinkUrl" class="form-label fw-bold">跳转链接 </label>
                            <asp:TextBox ID="txtLinkUrl" runat="server" CssClass="form-control form-control-ming" placeholder="如：~/Page/Index.aspx" />
                        </div>
                        <!-- 排序：必填且必须为数字 -->
                ...
                <!-- 右侧列 (图片上传) -->
                <div class="col-lg-4">
                    <label class="form-label fw-bold">轮播图片 </label>
                    <div class="mb-3">
                        <asp:FileUpload ID="fuImageUrl" runat="server" CssClass="form-control form-control-ming" />
 
                        <asp:CustomValidator ID="cvImageUrl" runat="server" 
                            ControlToValidate="fuImageUrl" 
                            ErrorMessage="* 请上传轮播图片 (仅支持 jpg, png, gif)" 
                            CssClass="validator-error" 
                            Display="Dynamic" 
                            OnServerValidate="cvImageUrl_ServerValidate" 
                            ValidateEmptyText="True" />
                        
                        <div class="img-preview-box mt-3">
                            <asp:Image ID="imgCurrentImage" runat="server" CssClass="img-preview" />
                            <span class="text-muted" id="imgPlaceholder" style="font-size: 0.8rem;">暂无图片</span>
                        </div>
                        <small class="text-muted d-block mt-2">提示：建议尺寸 1920x600，文件不超过 5MB</small>
                    </div>
                </div>
            </div>
    ...
    <div class="ming-card animate__animated animate__fadeInUp">
        <div class="card-header">
            ...
            <div>
                <asp:Button ID="btnAddNew" runat="server" Text="新增轮播" CssClass="btn btn-ming" OnClick="BtnAddNew_Click" CausesValidation="False" />
            </div>
        </div>

        <div class="table-responsive">
            <asp:GridView ID="gvBanner" runat="server" 
                ...
                GridLines="None"
                OnPageIndexChanging="GvBanner_PageIndexChanging" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="LinkUrl" HeaderText="跳转链接" />
                    <asp:BoundField DataField="Sort" HeaderText="排序" ItemStyle-Width="80" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptsPlaceHolder" Runat="Server">
    <script>
        ...
        function initAll() {
            ...
            // 选择文件实时预览
            $('#<%= fuImageUrl.ClientID %>').change(function () {
                var file = this.files[0];
                var $img = $('#<%= imgCurrentImage.ClientID %>');
