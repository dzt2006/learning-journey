<%@ Page Title="用户管理" Language="C#" MasterPageFile="~/Admin/Site_a.master" AutoEventWireup="true" CodeFile="UserManage.aspx.cs" Inherits="Admin_UserManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="ming-card mb-4 animate__animated animate__fadeInDown">
        ...
        <div class="search-row">
            <div class="search-item">
                <label for="txtSearchUserName">用户名：</label>
                <asp:TextBox ID="txtSearchUserName" runat="server" CssClass="form-control form-control-ming" style="width: 200px;" />
            </div>
            <div class="search-item">
        ...
        <div class="ming-card animate__animated animate__zoomIn">
            <div class="card-header">
                <h5 class="card-title">
                    ...
                    <asp:Literal ID="litEditTitle" runat="server" Text="新增用户"></asp:Literal>
                </h5>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    <div class="mb-3">
                        <label for="txtUserName" class="form-label fw-bold">用户名 </label>
                        <asp:TextBox ID="txtUserName" runat="server" CssClass="form-control form-control-ming" />
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="txtNickName" class="form-label fw-bold">昵称 </label>
                            <asp:TextBox ID="txtNickName" runat="server" CssClass="form-control form-control-ming" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="txtPwd" class="form-label fw-bold">密码 <span class="text-muted">(编辑时留空则不修改)</span></label>
                            <asp:TextBox ID="txtPwd" runat="server" CssClass="form-control form-control-ming" TextMode="Password" />
                            <asp:RequiredFieldValidator ID="rfvPwd" runat="server" 
                                ControlToValidate="txtPwd" 
                                ErrorMessage="* 新增用户必须输入密码" 
                                CssClass="validator-error" 
                                Display="Dynamic" />
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="txtEmail" class="form-label fw-bold">邮箱 </label>
                        <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control form-control-ming" />
                    </div>

                    <div class="mb-3">
                        <asp:CheckBox ID="chkStatus" runat="server" CssClass="form-check-input" Checked="true" />
                        <label class="form-check-label fw-bold" for="chkStatus">启用账号</label>
                    </div>
                </div>

                <div class="col-lg-4">
                    <label class="form-label fw-bold">用户头像</label>
                    <div class="mb-3">
                        <asp:FileUpload ID="fuAvatar" runat="server" CssClass="form-control form-control-ming" />
                        <asp:CustomValidator ID="cvAvatar" runat="server" 
                            ControlToValidate="fuAvatar" 
                            ErrorMessage="* 仅支持 jpg,png,gif" 
                            CssClass="validator-error" 
                            Display="Dynamic" 
                            OnServerValidate="cvAvatar_ServerValidate" 
    ...
    <div class="ming-card animate__animated animate__fadeInUp">
        <div class="card-header">
            ...
            <div>
                <asp:Button ID="btnAddNew" runat="server" Text="新增用户" CssClass="btn btn-ming" OnClick="BtnAddNew_Click" CausesValidation="False" />
            </div>
        </div>
        ...
        <div class="table-responsive">
            <asp:GridView ID="gvUser" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="状态" ItemStyle-Width="80">
                        <ItemTemplate>
                            <%# Eval("Status").ToString() == "True" ? "正常" : "禁用" %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="RegisterTime" HeaderText="注册时间" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False" />
